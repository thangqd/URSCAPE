...
class Ui_urscape_pop_form(object):
    def setupUi(self, urscape_pop_form):
        ...
        self.LblOutput = QtWidgets.QLabel(urscape_pop_form)
        ...
        self.output_file_name = QgsFileWidget(urscape_pop_form)
    ...
    def retranslateUi(self, urscape_pop_form):
        ...
        self.LblOutput.setText(_translate("urscape_pop_form", "Output"))
